...
#	OMP_NUM_THREADS=24 OMP_PROC_BIND=TRUE mpirun -np $numa_domains $bind_numa ./volna_mpi_openmp Problem.h5 0 old-format OP_PART_SIZE=4096 OP_PARTIAL_EXCHANGES=1 >> volna_mpi"$numa_domains"omp24_part4096_partial_diag2
	mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_global_aos    Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_global_aos
	mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_scalar_aos              Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_scalar_aos
	OP_AUTO_SOA=1 mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_scalar_soa  Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_scalar_soa
	OP_AUTO_SOA=1 mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_global_soa    Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_global_soa
	mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_scalar_blockloop_aos    Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_scalar_blockloop_aos
	OP_AUTO_SOA=1 mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_soa  Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_soa
	mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_aos      Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_aos
	OP_AUTO_SOA=1 mpirun -np $numa_domains $bind_numa ./volna_mpi_sycl_hier_scalar_blockloop_soa  Problem.h5 0 old-format OP_PART_SIZE=4096 >> volna_mpi"$numa_domains"_sycl_hier_scalar_blockloop_soa
