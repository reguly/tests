...
./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_aos
OP_AUTO_SOA=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_soa

OP2_COLOR2=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_global_aos

OP2_COLOR2=1 OP_AUTO_SOA=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_global_soa

OP2_SCALAR=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_scalar_aos

OP2_SCALAR=1 OP_AUTO_SOA=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_scalar_soa

OP2_SCALAR=1 OP2_BLOCKLOOP=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_scalar_blockloop_aos

OP2_SCALAR=1 OP2_BLOCKLOOP=1 OP_AUTO_SOA=1 ./translate2op2.sh
make sycl
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_hier_scalar_blockloop_soa

OP2_ATOMICS=1 OP_AUTO_SOA=1 ./translate2op2.sh
make sycl 
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_atomics_soa

OP2_ATOMICS=1 ./translate2op2.sh
make sycl 
mv bin/mgcfd_sycl bin/mgcfd_mpi_sycl_atomics_aos

cd $BASE/apps/volna/sp
./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_aos

OP_AUTO_SOA=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_soa

OP2_COLOR2=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_global_aos

OP2_COLOR2=1 OP_AUTO_SOA=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_global_soa

OP2_SCALAR=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_scalar_aos

OP2_SCALAR=1 OP_AUTO_SOA=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_scalar_soa

OP2_SCALAR=1 OP2_BLOCKLOOP=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_scalar_blockloop_aos

OP2_SCALAR=1 OP2_BLOCKLOOP=1 OP_AUTO_SOA=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_hier_scalar_blockloop_soa

OP2_ATOMICS=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_atomics_aos

OP2_ATOMICS=1 OP_AUTO_SOA=1 ./translate2op2.sh
make volna_sycl
mv volna_sycl volna_mpi_sycl_atomics_soa
fi
