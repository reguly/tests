  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rho_B0(xdim0_opensbliblock00Kernel001, ydim0_opensbliblock00Kernel001, &rho_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1 + n_z * xdim0_opensbliblock00Kernel001 * ydim0_opensbliblock00Kernel001*1);
        const ACC<double> rhou0_B0(xdim1_opensbliblock00Kernel001, ydim1_opensbliblock00Kernel001, &rhou0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1 + n_z * xdim1_opensbliblock00Kernel001 * ydim1_opensbliblock00Kernel001*1);
        ACC<double> u0_B0(xdim2_opensbliblock00Kernel001, ydim2_opensbliblock00Kernel001, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1 + n_z * xdim2_opensbliblock00Kernel001 * ydim2_opensbliblock00Kernel001*1);
        //USER CODE
