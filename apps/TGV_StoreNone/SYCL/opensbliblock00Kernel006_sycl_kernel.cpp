  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> wk4_B0(xdim1_opensbliblock00Kernel006, ydim1_opensbliblock00Kernel006, &wk4_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1 + n_z * xdim1_opensbliblock00Kernel006 * ydim1_opensbliblock00Kernel006*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
          
    wk4_B0(0,0,0) = (rc7_sycl[0])*inv_1_sycl[0]*(-8*u1_B0(0,0,-1) + u1_B0(0,0,-2) - u1_B0(0,0,2)
      + 8*u1_B0(0,0,1));
