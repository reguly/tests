...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* Residual3_B0_p = (double*)args[0].data_d;
  ...
  double* Residual4_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* Residual2_B0_p = (double*)args[4].data_d;
  ...
  double* rhou2_RKold_B0_p = (double*)args[8].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> Residual3_B0(xdim0_opensbliblock00Kernel034, ydim0_opensbliblock00Kernel034, &Residual3_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel034*1 + n_z * xdim0_opensbliblock00Kernel034 * ydim0_opensbliblock00Kernel034*1);
        const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel034, ydim1_opensbliblock00Kernel034, &Residual1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel034*1 + n_z * xdim1_opensbliblock00Kernel034 * ydim1_opensbliblock00Kernel034*1);
        const ACC<double> Residual0_B0(xdim2_opensbliblock00Kernel034, ydim2_opensbliblock00Kernel034, &Residual0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel034*1 + n_z * xdim2_opensbliblock00Kernel034 * ydim2_opensbliblock00Kernel034*1);
        const ACC<double> Residual4_B0(xdim3_opensbliblock00Kernel034, ydim3_opensbliblock00Kernel034, &Residual4_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel034*1 + n_z * xdim3_opensbliblock00Kernel034 * ydim3_opensbliblock00Kernel034*1);
        const ACC<double> Residual2_B0(xdim4_opensbliblock00Kernel034, ydim4_opensbliblock00Kernel034, &Residual2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel034*1 + n_z * xdim4_opensbliblock00Kernel034 * ydim4_opensbliblock00Kernel034*1);
        ACC<double> rhoE_RKold_B0(xdim5_opensbliblock00Kernel034, ydim5_opensbliblock00Kernel034, &rhoE_RKold_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel034*1 + n_z * xdim5_opensbliblock00Kernel034 * ydim5_opensbliblock00Kernel034*1);
        ACC<double> rho_RKold_B0(xdim6_opensbliblock00Kernel034, ydim6_opensbliblock00Kernel034, &rho_RKold_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel034*1 + n_z * xdim6_opensbliblock00Kernel034 * ydim6_opensbliblock00Kernel034*1);
        ACC<double> rhou0_RKold_B0(xdim7_opensbliblock00Kernel034, ydim7_opensbliblock00Kernel034, &rhou0_RKold_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel034*1 + n_z * xdim7_opensbliblock00Kernel034 * ydim7_opensbliblock00Kernel034*1);
        ACC<double> rhou2_RKold_B0(xdim8_opensbliblock00Kernel034, ydim8_opensbliblock00Kernel034, &rhou2_RKold_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel034*1 + n_z * xdim8_opensbliblock00Kernel034 * ydim8_opensbliblock00Kernel034*1);
        ACC<double> rhou1_RKold_B0(xdim9_opensbliblock00Kernel034, ydim9_opensbliblock00Kernel034, &rhou1_RKold_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel034*1 + n_z * xdim9_opensbliblock00Kernel034 * ydim9_opensbliblock00Kernel034*1);
