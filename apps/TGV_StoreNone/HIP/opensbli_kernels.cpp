...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"rcinv8")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv8), dat, dim*size));
  }
  else
  if (!strcmp(name,"rc9")) {
  ...
  if (!strcmp(name,"rcinv11")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv11), dat, dim*size));
  }
  else
