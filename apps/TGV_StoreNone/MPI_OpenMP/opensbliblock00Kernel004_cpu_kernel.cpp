  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> wk3_B0(xdim1_opensbliblock00Kernel004, ydim1_opensbliblock00Kernel004, wk3_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel004*1 + n_z * xdim1_opensbliblock00Kernel004 * ydim1_opensbliblock00Kernel004*1);
        
    wk3_B0(0,0,0) = (rc7)*inv_0*(-8*u1_B0(-1,0,0) + u1_B0(-2,0,0) +
