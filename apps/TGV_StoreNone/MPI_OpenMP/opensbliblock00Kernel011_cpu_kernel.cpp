  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> u2_B0(xdim0_opensbliblock00Kernel011, ydim0_opensbliblock00Kernel011, u2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel011*1 + n_z * xdim0_opensbliblock00Kernel011 * ydim0_opensbliblock00Kernel011*1);
        ACC<double> wk8_B0(xdim1_opensbliblock00Kernel011, ydim1_opensbliblock00Kernel011, wk8_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel011*1 + n_z * xdim1_opensbliblock00Kernel011 * ydim1_opensbliblock00Kernel011*1);
        
    wk8_B0(0,0,0) = (rc7)*inv_2*(u2_B0(0,-2,0) - u2_B0(0,2,0) + 8*u2_B0(0,1,0) -
      8*u2_B0(0,-1,0));
