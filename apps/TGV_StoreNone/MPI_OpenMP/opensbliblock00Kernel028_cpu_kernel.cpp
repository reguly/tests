  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel028, ydim0_opensbliblock00Kernel028, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1 + n_z * xdim0_opensbliblock00Kernel028 * ydim0_opensbliblock00Kernel028*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel028, ydim1_opensbliblock00Kernel028, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel028*1 + n_z * xdim1_opensbliblock00Kernel028 * ydim1_opensbliblock00Kernel028*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel028, ydim2_opensbliblock00Kernel028, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel028*1 + n_z * xdim2_opensbliblock00Kernel028 * ydim2_opensbliblock00Kernel028*1);
        ACC<double> rhou2_B0(xdim3_opensbliblock00Kernel028, ydim3_opensbliblock00Kernel028, rhou2_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel028*1 + n_z * xdim3_opensbliblock00Kernel028 * ydim3_opensbliblock00Kernel028*1);
        ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel028, ydim4_opensbliblock00Kernel028, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel028*1 + n_z * xdim4_opensbliblock00Kernel028 * ydim4_opensbliblock00Kernel028*1);
