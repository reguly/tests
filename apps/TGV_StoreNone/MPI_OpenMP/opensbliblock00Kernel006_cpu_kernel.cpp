  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> wk4_B0(xdim1_opensbliblock00Kernel006, ydim1_opensbliblock00Kernel006, wk4_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1 + n_z * xdim1_opensbliblock00Kernel006 * ydim1_opensbliblock00Kernel006*1);
        
    wk4_B0(0,0,0) = (rc7)*inv_1*(-8*u1_B0(0,0,-1) + u1_B0(0,0,-2) - u1_B0(0,0,2)
      + 8*u1_B0(0,0,1));
