...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel032(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel032) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel032 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel032=%d  -Dydim0_opensbliblock00Kernel032=%d  -Dxdim1_opensbliblock00Kernel032=%d  -Dydim1_opensbliblock00Kernel032=%d  -Dxdim2_opensbliblock00Kernel032=%d  -Dydim2_opensbliblock00Kernel032=%d  -Dxdim3_opensbliblock00Kernel032=%d  -Dydim3_opensbliblock00Kernel032=%d  -Dxdim4_opensbliblock00Kernel032=%d  -Dydim4_opensbliblock00Kernel032=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[0] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel032", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel032(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[0], 9, sizeof(cl_double), (void*) &Minf ));
