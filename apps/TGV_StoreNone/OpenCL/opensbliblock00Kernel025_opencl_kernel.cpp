    ...
    void buildOpenCLKernels_opensbliblock00Kernel025(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15, int xdim16, int ydim16) {
      ...
      if(!isbuilt_opensbliblock00Kernel025) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel025 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel025=%d  -Dydim0_opensbliblock00Kernel025=%d  -Dxdim1_opensbliblock00Kernel025=%d  -Dydim1_opensbliblock00Kernel025=%d  -Dxdim2_opensbliblock00Kernel025=%d  -Dydim2_opensbliblock00Kernel025=%d  -Dxdim3_opensbliblock00Kernel025=%d  -Dydim3_opensbliblock00Kernel025=%d  -Dxdim4_opensbliblock00Kernel025=%d  -Dydim4_opensbliblock00Kernel025=%d  -Dxdim5_opensbliblock00Kernel025=%d  -Dydim5_opensbliblock00Kernel025=%d  -Dxdim6_opensbliblock00Kernel025=%d  -Dydim6_opensbliblock00Kernel025=%d  -Dxdim7_opensbliblock00Kernel025=%d  -Dydim7_opensbliblock00Kernel025=%d  -Dxdim8_opensbliblock00Kernel025=%d  -Dydim8_opensbliblock00Kernel025=%d  -Dxdim9_opensbliblock00Kernel025=%d  -Dydim9_opensbliblock00Kernel025=%d  -Dxdim10_opensbliblock00Kernel025=%d  -Dydim10_opensbliblock00Kernel025=%d  -Dxdim11_opensbliblock00Kernel025=%d  -Dydim11_opensbliblock00Kernel025=%d  -Dxdim12_opensbliblock00Kernel025=%d  -Dydim12_opensbliblock00Kernel025=%d  -Dxdim13_opensbliblock00Kernel025=%d  -Dydim13_opensbliblock00Kernel025=%d  -Dxdim14_opensbliblock00Kernel025=%d  -Dydim14_opensbliblock00Kernel025=%d  -Dxdim15_opensbliblock00Kernel025=%d  -Dydim15_opensbliblock00Kernel025=%d  -Dxdim16_opensbliblock00Kernel025=%d  -Dydim16_opensbliblock00Kernel025=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15,xdim16,ydim16);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[23] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel025", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg14, ops_arg arg15, ops_arg arg16) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 17, sizeof(cl_double), (void*) &inv_1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 18, sizeof(cl_double), (void*) &inv_2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 19, sizeof(cl_double), (void*) &inv_3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 20, sizeof(cl_double), (void*) &inv_4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 21, sizeof(cl_double), (void*) &inv_5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 22, sizeof(cl_double), (void*) &rc7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 23, sizeof(cl_double), (void*) &rcinv8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 24, sizeof(cl_double), (void*) &rc9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 25, sizeof(cl_double), (void*) &rc10 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 26, sizeof(cl_double), (void*) &rcinv11 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 27, sizeof(cl_double), (void*) &rcinv12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 28, sizeof(cl_double), (void*) &rcinv13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 29, sizeof(cl_double), (void*) &rc14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 30, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 31, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 32, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 33, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 34, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 35, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 36, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 37, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 38, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 39, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 40, sizeof(cl_int), (void*) &base10 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 41, sizeof(cl_int), (void*) &base11 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 42, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 43, sizeof(cl_int), (void*) &base13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 44, sizeof(cl_int), (void*) &base14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 45, sizeof(cl_int), (void*) &base15 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 46, sizeof(cl_int), (void*) &base16 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 47, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 48, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[23], 49, sizeof(cl_int), (void*) &z_size ));
