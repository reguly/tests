...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel000(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel000) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel000 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel000=%d  -Dydim0_opensbliblock00Kernel000=%d  -Dxdim1_opensbliblock00Kernel000=%d  -Dydim1_opensbliblock00Kernel000=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel000=%d  -Dydim0_opensbliblock00Kernel000=%d  -Dxdim1_opensbliblock00Kernel000=%d  -Dydim1_opensbliblock00Kernel000=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
