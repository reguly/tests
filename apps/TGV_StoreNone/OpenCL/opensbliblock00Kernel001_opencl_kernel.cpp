...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel001(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {
      ...
      if(!isbuilt_opensbliblock00Kernel001) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[8] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel001", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel001(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[8], 8, sizeof(cl_int), (void*) &z_size ));
