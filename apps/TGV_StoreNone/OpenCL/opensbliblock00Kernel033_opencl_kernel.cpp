...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel033(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9) {
      ...
      if(!isbuilt_opensbliblock00Kernel033) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel033 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel033=%d  -Dydim0_opensbliblock00Kernel033=%d  -Dxdim1_opensbliblock00Kernel033=%d  -Dydim1_opensbliblock00Kernel033=%d  -Dxdim2_opensbliblock00Kernel033=%d  -Dydim2_opensbliblock00Kernel033=%d  -Dxdim3_opensbliblock00Kernel033=%d  -Dydim3_opensbliblock00Kernel033=%d  -Dxdim4_opensbliblock00Kernel033=%d  -Dydim4_opensbliblock00Kernel033=%d  -Dxdim5_opensbliblock00Kernel033=%d  -Dydim5_opensbliblock00Kernel033=%d  -Dxdim6_opensbliblock00Kernel033=%d  -Dydim6_opensbliblock00Kernel033=%d  -Dxdim7_opensbliblock00Kernel033=%d  -Dydim7_opensbliblock00Kernel033=%d  -Dxdim8_opensbliblock00Kernel033=%d  -Dydim8_opensbliblock00Kernel033=%d  -Dxdim9_opensbliblock00Kernel033=%d  -Dydim9_opensbliblock00Kernel033=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[7] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel033", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel033(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 10, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 11, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 12, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 13, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 14, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 15, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 16, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 17, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 18, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 19, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 20, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 21, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[7], 22, sizeof(cl_int), (void*) &z_size ));
