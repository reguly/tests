    ...
    void buildOpenCLKernels_opensbliblock00Kernel024(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15, int xdim16, int ydim16) {
      ...
      if(!isbuilt_opensbliblock00Kernel024) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel024 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel024=%d  -Dydim0_opensbliblock00Kernel024=%d  -Dxdim1_opensbliblock00Kernel024=%d  -Dydim1_opensbliblock00Kernel024=%d  -Dxdim2_opensbliblock00Kernel024=%d  -Dydim2_opensbliblock00Kernel024=%d  -Dxdim3_opensbliblock00Kernel024=%d  -Dydim3_opensbliblock00Kernel024=%d  -Dxdim4_opensbliblock00Kernel024=%d  -Dydim4_opensbliblock00Kernel024=%d  -Dxdim5_opensbliblock00Kernel024=%d  -Dydim5_opensbliblock00Kernel024=%d  -Dxdim6_opensbliblock00Kernel024=%d  -Dydim6_opensbliblock00Kernel024=%d  -Dxdim7_opensbliblock00Kernel024=%d  -Dydim7_opensbliblock00Kernel024=%d  -Dxdim8_opensbliblock00Kernel024=%d  -Dydim8_opensbliblock00Kernel024=%d  -Dxdim9_opensbliblock00Kernel024=%d  -Dydim9_opensbliblock00Kernel024=%d  -Dxdim10_opensbliblock00Kernel024=%d  -Dydim10_opensbliblock00Kernel024=%d  -Dxdim11_opensbliblock00Kernel024=%d  -Dydim11_opensbliblock00Kernel024=%d  -Dxdim12_opensbliblock00Kernel024=%d  -Dydim12_opensbliblock00Kernel024=%d  -Dxdim13_opensbliblock00Kernel024=%d  -Dydim13_opensbliblock00Kernel024=%d  -Dxdim14_opensbliblock00Kernel024=%d  -Dydim14_opensbliblock00Kernel024=%d  -Dxdim15_opensbliblock00Kernel024=%d  -Dydim15_opensbliblock00Kernel024=%d  -Dxdim16_opensbliblock00Kernel024=%d  -Dydim16_opensbliblock00Kernel024=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15,xdim16,ydim16);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[22] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel024", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 17, sizeof(cl_double), (void*) &inv_0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 18, sizeof(cl_double), (void*) &inv_1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 19, sizeof(cl_double), (void*) &inv_2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 20, sizeof(cl_double), (void*) &rc6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 21, sizeof(cl_double), (void*) &rc7 ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 35, sizeof(cl_int), (void*) &base13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 36, sizeof(cl_int), (void*) &base14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 37, sizeof(cl_int), (void*) &base15 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 38, sizeof(cl_int), (void*) &base16 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 39, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 40, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[22], 41, sizeof(cl_int), (void*) &z_size ));
