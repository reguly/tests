...
#include "defdec_data_set.h"
  ...
  ops_par_loop_opensbliblock00Kernel032("Grid_based_initialisation0", opensbliblock00, 3, iteration_range_32_block0,
  ...
  for(int iter=0; iter<=niter - 1; iter++)
  {
    ...
    for(int stage=0; stage<=2; stage++)
    {
      ...
      ops_par_loop_opensbliblock00Kernel001("CRu0_B0", opensbliblock00, 3, iteration_range_1_block0,
                   ops_arg_dat(rho_B0, 1, stencil_0_03, "double", OPS_READ),
                   ops_arg_dat(rhou0_B0, 1, stencil_0_03, "double", OPS_READ),
