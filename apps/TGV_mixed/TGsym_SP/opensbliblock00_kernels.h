...
ACC<float> &rhou2_B0, const int *idx)
{
   ...
   p = (2.0f + cosf(2.0f*x2))*(0.0625f*cosf(2.0f*x0) + 0.0625f*cosf(2.0f*x1)) + 1.0f/((Minf*Minf)*gama);
...
ACC<float> &rhou0_B0, const ACC<float> &rhou1_B0, const ACC<float> &rhou2_B0, const ACC<float> &u0_B0, ACC<float>
...
void opensbliblock00Kernel005(const ACC<float> &rhou0_B0, ACC<float> &wk1_B0)
{
...
void opensbliblock00Kernel009(const ACC<float> &p_B0, ACC<float> &wk3_B0)
{
...
void opensbliblock00Kernel012(const ACC<float> &rhoE_B0, ACC<float> &wk5_B0)
{
...
void opensbliblock00Kernel013(const ACC<float> &rhou1_B0, ACC<float> &wk6_B0)
{
...
void opensbliblock00Kernel017(const ACC<float> &u0_B0, ACC<float> &wk9_B0)
{
...
void opensbliblock00Kernel018(const ACC<float> &rhou2_B0, ACC<float> &wk10_B0)
{
...
void opensbliblock00Kernel020(const ACC<float> &rho_B0, ACC<float> &wk12_B0)
{
...
ACC<float> &rhou0_B0, const ACC<float> &rhou1_B0, const ACC<float> &rhou2_B0, const ACC<float> &u1_B0, ACC<float>
&wk39_B0, ACC<float> &wk40_B0, ACC<float> &wk41_B0, ACC<float> &wk42_B0, ACC<float> &wk43_B0, ACC<float> &wk44_B0)
{
...
void opensbliblock00Kernel022(const ACC<float> &rhou1_B0, ACC<float> &wk13_B0)
{
...
void opensbliblock00Kernel023(const ACC<float> &rho_B0, ACC<float> &wk14_B0)
{
...
void opensbliblock00Kernel027(const ACC<float> &rhou2_B0, ACC<float> &wk17_B0)
{
...
void opensbliblock00Kernel028(const ACC<float> &p_B0, ACC<float> &wk18_B0)
{
...
void opensbliblock00Kernel030(const ACC<float> &rhoE_B0, ACC<float> &wk20_B0)
{
...
void opensbliblock00Kernel031(const ACC<float> &rhou0_B0, ACC<float> &wk21_B0)
{
...
void opensbliblock00Kernel033(const ACC<float> &u1_B0, ACC<float> &wk23_B0)
{
...
ACC<float> &rhou0_B0, const ACC<float> &rhou1_B0, const ACC<float> &rhou2_B0, const ACC<float> &u2_B0, ACC<float>
&wk39_B0, ACC<float> &wk40_B0, ACC<float> &wk41_B0, ACC<float> &wk42_B0, ACC<float> &wk43_B0, ACC<float> &wk44_B0)
{
...
void opensbliblock00Kernel039(const ACC<float> &rhoE_B0, ACC<float> &wk27_B0)
{
...
void opensbliblock00Kernel041(const ACC<float> &rhou0_B0, ACC<float> &wk29_B0)
{
...
void opensbliblock00Kernel044(const ACC<float> &rhou1_B0, ACC<float> &wk32_B0)
{
...
void opensbliblock00Kernel045(const ACC<float> &p_B0, ACC<float> &wk33_B0)
{
...
void opensbliblock00Kernel046(const ACC<float> &rhou2_B0, ACC<float> &wk34_B0)
{
...
void opensbliblock00Kernel049(const ACC<float> &rho_B0, ACC<float> &wk37_B0)
{
...
void opensbliblock00Kernel050(const ACC<float> &u2_B0, ACC<float> &wk38_B0)
{
...
&u2_B0, const ACC<float> &wk0_B0, const ACC<float> &wk10_B0, const ACC<float> &wk11_B0, const ACC<float> &wk12_B0, const
ACC<float> &wk13_B0, const ACC<float> &wk14_B0, const ACC<float> &wk15_B0, const ACC<float> &wk16_B0, const ACC<float>
&wk17_B0, const ACC<float> &wk18_B0, const ACC<float> &wk19_B0, const ACC<float> &wk1_B0, const ACC<float> &wk20_B0,
const ACC<float> &wk21_B0, const ACC<float> &wk22_B0, const ACC<float> &wk23_B0, const ACC<float> &wk24_B0, const
ACC<float> &wk25_B0, const ACC<float> &wk26_B0, const ACC<float> &wk27_B0, const ACC<float> &wk28_B0, const ACC<float>
&wk29_B0, const ACC<float> &wk2_B0, const ACC<float> &wk30_B0, const ACC<float> &wk31_B0, const ACC<float> &wk32_B0,
const ACC<float> &wk33_B0, const ACC<float> &wk34_B0, const ACC<float> &wk35_B0, const ACC<float> &wk36_B0, const
ACC<float> &wk37_B0, const ACC<float> &wk38_B0, const ACC<float> &wk3_B0, const ACC<float> &wk4_B0, const ACC<float>
&wk5_B0, const ACC<float> &wk6_B0, const ACC<float> &wk7_B0, const ACC<float> &wk8_B0, const ACC<float> &wk9_B0,
ACC<float> &Residual0_B0, ACC<float> &Residual1_B0, ACC<float> &Residual2_B0, ACC<float> &Residual3_B0, ACC<float>
&Residual4_B0)
{
    Residual0_B0(0,0,0) = -(1.0f/2.0f)*wk8_B0(0,0,0) - (1.0f/2.0f)*wk16_B0(0,0,0) - (1.0f/2.0f)*wk30_B0(0,0,0) -
      (1.0f/2.0f)*(wk9_B0(0,0,0) + wk23_B0(0,0,0) + wk38_B0(0,0,0))*rho_B0(0,0,0) -
      (1.0f/2.0f)*u0_B0(0,0,0)*wk12_B0(0,0,0) - (1.0f/2.0f)*u1_B0(0,0,0)*wk14_B0(0,0,0) -
      (1.0f/2.0f)*u2_B0(0,0,0)*wk37_B0(0,0,0);
...
void opensbliblock00Kernel053(const ACC<float> &u0_B0, ACC<float> &wk1_B0)
{
...
void opensbliblock00Kernel055(const ACC<float> &T_B0, ACC<float> &wk3_B0)
{
...
void opensbliblock00Kernel057(const ACC<float> &u2_B0, ACC<float> &wk5_B0)
{
   wk5_B0(0,0,0) = -(1.0f/12.0f)*(-u2_B0(0,-2,0) - 8*u2_B0(0,1,0) + 8*u2_B0(0,-1,0) + u2_B0(0,2,0))*invDelta1block0;

}

void opensbliblock00Kernel058(const ACC<float> &u0_B0, ACC<float> &wk6_B0)
{
   wk6_B0(0,0,0) = -(1.0f/12.0f)*(-u0_B0(0,-2,0) - 8*u0_B0(0,1,0) + 8*u0_B0(0,-1,0) + u0_B0(0,2,0))*invDelta1block0;

}

void opensbliblock00Kernel059(const ACC<float> &u2_B0, ACC<float> &wk7_B0)
{
...
void opensbliblock00Kernel060(const ACC<float> &u1_B0, ACC<float> &wk8_B0)
{
...
void opensbliblock00Kernel061(const ACC<float> &u1_B0, ACC<float> &wk9_B0)
{
...
void opensbliblock00Kernel063(const ACC<float> &u1_B0, ACC<float> &wk11_B0)
{
   wk11_B0(0,0,0) = ((1.0f/12.0f))*(-u1_B0(0,0,2) - 8*u1_B0(0,0,-1) + 8*u1_B0(0,0,1) + u1_B0(0,0,-2))*invDelta2block0;

}

void opensbliblock00Kernel064(const ACC<float> &u1_B0, ACC<float> &wk12_B0)
{
...
void opensbliblock00Kernel065(const ACC<float> &u2_B0, ACC<float> &wk13_B0)
{
...
void opensbliblock00Kernel066(const ACC<float> &u2_B0, ACC<float> &wk14_B0)
{
...
void opensbliblock00Kernel067(const ACC<float> &u0_B0, ACC<float> &wk15_B0)
{
...
void opensbliblock00Kernel068(const ACC<float> &u0_B0, ACC<float> &wk16_B0)
{
...
void opensbliblock00Kernel069(const ACC<float> &u1_B0, ACC<float> &wk17_B0)
{
   wk17_B0(0,0,0) = -(1.0f/12.0f)*(-u1_B0(-2,0,0) - 8*u1_B0(1,0,0) + 8*u1_B0(-1,0,0) + u1_B0(2,0,0))*invDelta0block0;

}

void opensbliblock00Kernel070(const ACC<float> &u1_B0, ACC<float> &wk18_B0)
{
   wk18_B0(0,0,0) = -(1.0f/12.0f)*(-u1_B0(0,-2,0) - 8*u1_B0(0,1,0) + 8*u1_B0(0,-1,0) + u1_B0(0,2,0))*invDelta1block0;

}

void opensbliblock00Kernel073(const ACC<float> &T_B0, ACC<float> &wk21_B0)
{
...
{
    wk4_B0(0,0,0) = ((1.0f/12.0f))*(-wk5_B0(0,0,2) - 8*wk5_B0(0,0,-1) + 8*wk5_B0(0,0,1) +
...
&wk9_B0, ACC<float> &Residual1_B0, ACC<float> &Residual2_B0, ACC<float> &Residual3_B0, ACC<float> &Residual4_B0)
{
    Residual1_B0(0,0,0) = 1.0f*(((1.0f/3.0f))*wk10_B0(0,0,0) + ((1.0f/3.0f))*wk19_B0(0,0,0) +
      ((4.0f/3.0f))*wk1_B0(0,0,0) + wk15_B0(0,0,0) + wk16_B0(0,0,0))*invRe + Residual1_B0(0,0,0);
    ...
    Residual3_B0(0,0,0) = 1.0f*(((1.0f/3.0f))*wk0_B0(0,0,0) + ((1.0f/3.0f))*wk20_B0(0,0,0) +
      ((4.0f/3.0f))*wk13_B0(0,0,0) + wk7_B0(0,0,0) + wk14_B0(0,0,0))*invRe + Residual3_B0(0,0,0);
    ...
    Residual4_B0(0,0,0) = 1.0f*(wk5_B0(0,0,0) + wk11_B0(0,0,0))*invRe*wk5_B0(0,0,0) + 1.0f*(wk5_B0(0,0,0) +
      ...
      1.0f*(-(2.0f/3.0f)*wk18_B0(0,0,0) - (2.0f/3.0f)*wk24_B0(0,0,0) +
      ((4.0f/3.0f))*wk25_B0(0,0,0))*invRe*wk25_B0(0,0,0) + 1.0f*(-(2.0f/3.0f)*wk18_B0(0,0,0) -
      (2.0f/3.0f)*wk25_B0(0,0,0) + ((4.0f/3.0f))*wk24_B0(0,0,0))*invRe*wk24_B0(0,0,0) +
      1.0f*(-(2.0f/3.0f)*wk24_B0(0,0,0) - (2.0f/3.0f)*wk25_B0(0,0,0) +
      ((4.0f/3.0f))*wk18_B0(0,0,0))*invRe*wk18_B0(0,0,0) + 1.0f*(((1.0f/3.0f))*wk0_B0(0,0,0) +
      ((1.0f/3.0f))*wk20_B0(0,0,0) + ((4.0f/3.0f))*wk13_B0(0,0,0) + wk7_B0(0,0,0) + wk14_B0(0,0,0))*invRe*u2_B0(0,0,0) +
      1.0f*(((1.0f/3.0f))*wk2_B0(0,0,0) + ((1.0f/3.0f))*wk4_B0(0,0,0) + ((4.0f/3.0f))*wk8_B0(0,0,0) + wk9_B0(0,0,0) +
      wk12_B0(0,0,0))*invRe*u1_B0(0,0,0) + 1.0f*(((1.0f/3.0f))*wk10_B0(0,0,0) + ((1.0f/3.0f))*wk19_B0(0,0,0) +
      ((4.0f/3.0f))*wk1_B0(0,0,0) + wk15_B0(0,0,0) + wk16_B0(0,0,0))*invRe*u0_B0(0,0,0) + 1.0f*(wk3_B0(0,0,0) +
