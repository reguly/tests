//OMP_NUM_THREADS=1 mpirun -np 144 -bind-to core ./opensbli_mpi_tiled -OPS_DIAGS=2 OPS_TILING_MAXDEPTH=12 OPS_TILESIZE_X=-1 OPS_TILESIZE_Y=12 OPS_TILESIZE_Z=8
//OMP_NUM_THREADS=1 mpirun -np 144 -bind-to core ./opensbli_mpi_tiled -OPS_DIAGS=2 OPS_TILING_MAXDEPTH=12 OPS_CACHE_SIZE=3
#include <stdlib.h> 
#include <string.h> 
#include <math.h> 
#ifdef PROFILE_ITT
...
niter = 20;
half rkold[] = {(1.0/4.0), (3.0/20.0), (3.0/5.0)};
half rknew[] = {(2.0/3.0), (5.0/12.0), (3.0/5.0)};
dt = 0.00125;
...
ops_decl_const("Delta0block0" , 1, "half", &Delta0block0);
ops_decl_const("Delta1block0" , 1, "half", &Delta1block0);
ops_decl_const("Delta2block0" , 1, "half", &Delta2block0);
ops_decl_const("HDF5_timing" , 1, "int", &HDF5_timing);
ops_decl_const("Minf" , 1, "half", &Minf);
ops_decl_const("Pr" , 1, "half", &Pr);
ops_decl_const("Re" , 1, "half", &Re);
ops_decl_const("block0np0" , 1, "int", &block0np0);
ops_decl_const("block0np1" , 1, "int", &block0np1);
ops_decl_const("block0np2" , 1, "int", &block0np2);
ops_decl_const("dt" , 1, "half", &dt);
ops_decl_const("gama" , 1, "half", &gama);
ops_decl_const("inv2Delta0block0" , 1, "half", &inv2Delta0block0);
ops_decl_const("inv2Delta1block0" , 1, "half", &inv2Delta1block0);
ops_decl_const("inv2Delta2block0" , 1, "half", &inv2Delta2block0);
ops_decl_const("inv2Minf" , 1, "half", &inv2Minf);
ops_decl_const("invDelta0block0" , 1, "half", &invDelta0block0);
ops_decl_const("invDelta1block0" , 1, "half", &invDelta1block0);
ops_decl_const("invDelta2block0" , 1, "half", &invDelta2block0);
ops_decl_const("invPr" , 1, "half", &invPr);
ops_decl_const("invRe" , 1, "half", &invRe);
ops_decl_const("inv_gamma_m1" , 1, "half", &inv_gamma_m1);
ops_decl_const("niter" , 1, "int", &niter);
ops_decl_const("simulation_time" , 1, "half", &simulation_time);
...
if (restart == 1){
ops_get_const_hdf5("simulation_time", 1, "half", (char*)&simulation_time, "restart.h5");
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_idx());
}
...
ops_arg_dat(rhoE_B0, 1, stencil_0_22_00_00_8, "half", OPS_RW),
ops_arg_dat(rho_B0, 1, stencil_0_22_00_00_8, "half", OPS_RW),
ops_arg_dat(rhou0_B0, 1, stencil_0_22_00_00_8, "half", OPS_RW),
ops_arg_dat(rhou1_B0, 1, stencil_0_22_00_00_8, "half", OPS_RW),
ops_arg_dat(rhou2_B0, 1, stencil_0_22_00_00_8, "half", OPS_RW));
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_22_00_8, "half", OPS_RW),
ops_arg_dat(rho_B0, 1, stencil_0_00_22_00_8, "half", OPS_RW),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_22_00_8, "half", OPS_RW),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_22_00_8, "half", OPS_RW),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_22_00_8, "half", OPS_RW));
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_22_8, "half", OPS_RW),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_22_8, "half", OPS_RW),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_22_8, "half", OPS_RW),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_22_8, "half", OPS_RW),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_22_8, "half", OPS_RW));
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rho_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(T_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(rhou0_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(p_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(rhoE_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(rhou1_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(u0_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(rhou2_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(rho_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
...
ops_arg_dat(rhou1_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(rho_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(rhou2_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(p_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(rhou0_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(u1_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
...
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(p_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(rho_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(u2_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
...
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u0_B0, 1, stencil_0_22_00_00_11, "half", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(T_B0, 1, stencil_0_22_00_00_11, "half", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u2_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u0_B0, 1, stencil_0_00_22_00_8, "half", OPS_READ),
ops_arg_dat(wk6_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u2_B0, 1, stencil_0_00_22_00_11, "half", OPS_READ),
ops_arg_dat(wk7_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u1_B0, 1, stencil_0_00_22_00_11, "half", OPS_READ),
ops_arg_dat(wk8_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u1_B0, 1, stencil_0_00_00_22_11, "half", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u1_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u1_B0, 1, stencil_0_22_00_00_11, "half", OPS_READ),
ops_arg_dat(wk12_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u2_B0, 1, stencil_0_00_00_22_11, "half", OPS_READ),
ops_arg_dat(wk13_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u2_B0, 1, stencil_0_22_00_00_11, "half", OPS_READ),
ops_arg_dat(wk14_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u0_B0, 1, stencil_0_00_00_22_11, "half", OPS_READ),
ops_arg_dat(wk15_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u0_B0, 1, stencil_0_00_22_00_11, "half", OPS_READ),
ops_arg_dat(wk16_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u1_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
ops_arg_dat(wk17_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(T_B0, 1, stencil_0_00_22_00_11, "half", OPS_READ),
ops_arg_dat(wk21_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u2_B0, 1, stencil_0_22_00_00_8, "half", OPS_READ),
ops_arg_dat(wk22_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(u0_B0, 1, stencil_0_00_00_22_8, "half", OPS_READ),
ops_arg_dat(wk23_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(T_B0, 1, stencil_0_00_00_22_11, "half", OPS_READ),
ops_arg_dat(wk26_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE));
...
ops_arg_dat(wk8_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW));
...
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rho_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "half", OPS_WRITE),
ops_arg_gbl(&rknew[stage], 1, "half", OPS_READ));
...
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(Residual4_B0, 1, stencil_0_00_00_00_3, "half", OPS_READ),
ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(rho_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_00_00_00_3, "half", OPS_RW),
ops_arg_gbl(&rkold[stage], 1, "half", OPS_READ));
