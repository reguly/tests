...
ACC<half> &Residual2_B0, ACC<half> &Residual3_B0, ACC<half> &Residual4_B0)
{
    Residual0_B0(0,0,0) = -(half(1.0)/half(2.0))*wk8_B0(0,0,0) - (half(1.0)/half(2.0))*wk16_B0(0,0,0) - (half(1.0)/half(2.0))*wk30_B0(0,0,0) -
      (half(1.0)/half(2.0))*(wk9_B0(0,0,0) + wk23_B0(0,0,0) + wk38_B0(0,0,0))*rho_B0(0,0,0) - (half(1.0)/half(2.0))*u0_B0(0,0,0)*wk12_B0(0,0,0)
      - (half(1.0)/half(2.0))*u1_B0(0,0,0)*wk14_B0(0,0,0) - (half(1.0)/half(2.0))*u2_B0(0,0,0)*wk37_B0(0,0,0);
...
{
    wk1_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u0_B0(1,0,0) - half(16)*u0_B0(-1,0,0) + 30*u0_B0(0,0,0) + u0_B0(-2,0,0) +
...
{
    wk3_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*T_B0(1,0,0) - half(16)*T_B0(-1,0,0) + 30*T_B0(0,0,0) + T_B0(-2,0,0) +
...
{
    wk7_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u2_B0(0,1,0) - half(16)*u2_B0(0,-1,0) + 30*u2_B0(0,0,0) + u2_B0(0,-2,0) +
...
{
    wk8_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u1_B0(0,1,0) - half(16)*u1_B0(0,-1,0) + 30*u1_B0(0,0,0) + u1_B0(0,-2,0) +
...
{
    wk9_B0(0,0,0) = ((half(1.0)/half(12.0)))*(-u1_B0(0,0,-2) - u1_B0(0,0,2) - 30*u1_B0(0,0,0) + half(16)*u1_B0(0,0,1) +
...
{
    wk12_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u1_B0(1,0,0) - half(16)*u1_B0(-1,0,0) + 30*u1_B0(0,0,0) + u1_B0(-2,0,0) +
...
{
    wk13_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u2_B0(0,0,1) - half(16)*u2_B0(0,0,-1) + 30*u2_B0(0,0,0) + u2_B0(0,0,-2) +
...
{
    wk14_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u2_B0(1,0,0) - half(16)*u2_B0(-1,0,0) + 30*u2_B0(0,0,0) + u2_B0(-2,0,0) +
...
{
    wk15_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u0_B0(0,0,1) - half(16)*u0_B0(0,0,-1) + 30*u0_B0(0,0,0) + u0_B0(0,0,-2) +
...
{
    wk16_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*u0_B0(0,1,0) - half(16)*u0_B0(0,-1,0) + 30*u0_B0(0,0,0) + u0_B0(0,-2,0) +
...
{
    wk21_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*T_B0(0,1,0) - half(16)*T_B0(0,-1,0) + 30*T_B0(0,0,0) + T_B0(0,-2,0) +
...
{
    wk26_B0(0,0,0) = -(half(1.0)/half(12.0))*(-half(16)*T_B0(0,0,1) - half(16)*T_B0(0,0,-1) + 30*T_B0(0,0,0) + T_B0(0,0,-2) +
...
{
   wk4_B0(0,0,0) = ((half(1.0)/half(12.0)))*(-wk5_B0(0,0,2) - 8*wk5_B0(0,0,-1) + 8*wk5_B0(0,0,1) + wk5_B0(0,0,-2))*invDelta2block0;
...
ACC<half> &Residual2_B0, ACC<half> &Residual3_B0, ACC<half> &Residual4_B0)
{
    Residual1_B0(0,0,0) = half(1.0)*(((half(1.0)/half(3.0)))*wk10_B0(0,0,0) + ((half(1.0)/half(3.0)))*wk19_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk1_B0(0,0,0) +
    ...
    Residual3_B0(0,0,0) = half(1.0)*(((half(1.0)/half(3.0)))*wk0_B0(0,0,0) + ((half(1.0)/half(3.0)))*wk20_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk13_B0(0,0,0) +
    ...
    Residual4_B0(0,0,0) = half(1.0)*(wk5_B0(0,0,0) + wk11_B0(0,0,0))*invRe*wk5_B0(0,0,0) + half(1.0)*(wk5_B0(0,0,0) +
      ...
      half(1.0)*(-(half(2.0)/half(3.0))*wk18_B0(0,0,0) - (half(2.0)/half(3.0))*wk24_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk25_B0(0,0,0))*invRe*wk25_B0(0,0,0) +
      half(1.0)*(-(half(2.0)/half(3.0))*wk18_B0(0,0,0) - (half(2.0)/half(3.0))*wk25_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk24_B0(0,0,0))*invRe*wk24_B0(0,0,0) +
      half(1.0)*(-(half(2.0)/half(3.0))*wk24_B0(0,0,0) - (half(2.0)/half(3.0))*wk25_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk18_B0(0,0,0))*invRe*wk18_B0(0,0,0) +
      half(1.0)*(((half(1.0)/half(3.0)))*wk0_B0(0,0,0) + ((half(1.0)/half(3.0)))*wk20_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk13_B0(0,0,0) + wk7_B0(0,0,0) +
      wk14_B0(0,0,0))*invRe*u2_B0(0,0,0) + half(1.0)*(((half(1.0)/half(3.0)))*wk2_B0(0,0,0) + ((half(1.0)/half(3.0)))*wk4_B0(0,0,0) +
      ((half(4.0)/half(3.0)))*wk8_B0(0,0,0) + wk9_B0(0,0,0) + wk12_B0(0,0,0))*invRe*u1_B0(0,0,0) + half(1.0)*(((half(1.0)/half(3.0)))*wk10_B0(0,0,0) +
      ((half(1.0)/half(3.0)))*wk19_B0(0,0,0) + ((half(4.0)/half(3.0)))*wk1_B0(0,0,0) + wk15_B0(0,0,0) + wk16_B0(0,0,0))*invRe*u0_B0(0,0,0) +
      half(1.0)*(wk3_B0(0,0,0) + wk21_B0(0,0,0) + wk26_B0(0,0,0))*invPr*invRe*inv2Minf*inv_gamma_m1 + Residual4_B0(0,0,0);
