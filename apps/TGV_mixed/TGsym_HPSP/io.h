...
ops_write_const_hdf5("Delta0block0", 1, "float", (char*)&Delta0block0, filename);
ops_write_const_hdf5("Delta1block0", 1, "float", (char*)&Delta1block0, filename);
ops_write_const_hdf5("Delta2block0", 1, "float", (char*)&Delta2block0, filename);
ops_write_const_hdf5("HDF5_timing", 1, "int", (char*)&HDF5_timing, filename);
ops_write_const_hdf5("Minf", 1, "float", (char*)&Minf, filename);
ops_write_const_hdf5("Pr", 1, "float", (char*)&Pr, filename);
ops_write_const_hdf5("Re", 1, "float", (char*)&Re, filename);
...
ops_write_const_hdf5("dt", 1, "float", (char*)&dt, filename);
ops_write_const_hdf5("gama", 1, "float", (char*)&gama, filename);
ops_write_const_hdf5("niter", 1, "int", (char*)&niter, filename);
ops_write_const_hdf5("simulation_time", 1, "float", (char*)&simulation_time, filename);
