...
void opensbliblock00Kernel061_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk9_B0)
{
    wk9_B0(0,0,0) = -rc8*inv_1*(-u1_B0(-2,0,0) - 8*u1_B0(1,0,0) +
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel061[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel061[0][0] * (size_t)dims_opensbliblock00Kernel061[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel061[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel061[1][0] * (size_t)dims_opensbliblock00Kernel061[1][1];
