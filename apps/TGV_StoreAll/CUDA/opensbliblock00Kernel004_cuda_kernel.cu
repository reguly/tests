...
void opensbliblock00Kernel004_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk1_B0)
{
    wk1_B0(0,0,0) = inv_0*(-rc7*u1_B0(0,-1,0) + (rc7)*u1_B0(0,1,0) -
      rc8*u1_B0(0,2,0) + (rc8)*u1_B0(0,-2,0));
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel004[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel004[0][0] * (size_t)dims_opensbliblock00Kernel004[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel004[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel004[1][0] * (size_t)dims_opensbliblock00Kernel004[1][1];
