...
void opensbliblock00Kernel034_gpu(const ACC<double> &rho_B0,
  ACC<double> &wk24_B0)
{
    wk24_B0(0,0,0) = inv_1*(-rc8*rho_B0(2,0,0) + (rc8)*rho_B0(-2,0,0) -
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel034[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel034[0][0] * (size_t)dims_opensbliblock00Kernel034[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel034[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel034[1][0] * (size_t)dims_opensbliblock00Kernel034[1][1];
