...
void opensbliblock00Kernel016_gpu(const ACC<double> &wk42_B0,
  ACC<double> &wk9_B0)
{
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel016[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel016[0][0] * (size_t)dims_opensbliblock00Kernel016[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel016[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel016[1][0] * (size_t)dims_opensbliblock00Kernel016[1][1];
