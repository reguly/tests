...
void opensbliblock00Kernel046_gpu(const ACC<double> &wk42_B0,
  ACC<double> &wk34_B0)
{
    wk34_B0(0,0,0) = inv_2*(-rc7*wk42_B0(0,0,-1) - rc8*wk42_B0(0,0,2) +
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel046[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel046[0][0] * (size_t)dims_opensbliblock00Kernel046[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel046[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel046[1][0] * (size_t)dims_opensbliblock00Kernel046[1][1];
