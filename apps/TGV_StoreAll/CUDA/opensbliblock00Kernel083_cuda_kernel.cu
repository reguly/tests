...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel083[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel083[0][0] * (size_t)dims_opensbliblock00Kernel083[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel083[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel083[1][0] * (size_t)dims_opensbliblock00Kernel083[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel083[2][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel083[2][0] * (size_t)dims_opensbliblock00Kernel083[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel083[3][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel083[3][0] * (size_t)dims_opensbliblock00Kernel083[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel083[4][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel083[4][0] * (size_t)dims_opensbliblock00Kernel083[4][1];
