...
void opensbliblock00Kernel064_gpu(const ACC<double> &wk6_B0,
  ACC<double> &wk12_B0)
{
    wk12_B0(0,0,0) = (rc8)*inv_2*(wk6_B0(0,0,-2) - 8*wk6_B0(0,0,-1) +
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel064[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel064[0][0] * (size_t)dims_opensbliblock00Kernel064[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel064[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel064[1][0] * (size_t)dims_opensbliblock00Kernel064[1][1];
