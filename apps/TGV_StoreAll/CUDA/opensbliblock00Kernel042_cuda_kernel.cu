...
void opensbliblock00Kernel042_gpu(const ACC<double> &wk41_B0,
  ACC<double> &wk30_B0)
{
    wk30_B0(0,0,0) = inv_2*((rc7)*wk41_B0(0,0,1) - rc8*wk41_B0(0,0,2) +
      (rc8)*wk41_B0(0,0,-2) - rc7*wk41_B0(0,0,-1));
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel042[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel042[0][0] * (size_t)dims_opensbliblock00Kernel042[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel042[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel042[1][0] * (size_t)dims_opensbliblock00Kernel042[1][1];
