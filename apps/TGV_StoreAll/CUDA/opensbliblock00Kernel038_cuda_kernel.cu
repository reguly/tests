...
void opensbliblock00Kernel038_gpu(const ACC<double> &rho_B0,
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel038[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel038[0][0] * (size_t)dims_opensbliblock00Kernel038[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel038[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel038[1][0] * (size_t)dims_opensbliblock00Kernel038[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel038[2][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel038[2][0] * (size_t)dims_opensbliblock00Kernel038[2][1];
