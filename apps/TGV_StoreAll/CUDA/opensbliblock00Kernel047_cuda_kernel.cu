...
void opensbliblock00Kernel047_gpu(const ACC<double> &wk43_B0,
  ACC<double> &wk35_B0)
{
    wk35_B0(0,0,0) = inv_2*(-rc8*wk43_B0(0,0,2) + (rc7)*wk43_B0(0,0,1) +
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel047[0][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel047[0][0] * (size_t)dims_opensbliblock00Kernel047[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * (size_t)dims_opensbliblock00Kernel047[1][0] + idx_z * 1*1 * (size_t)dims_opensbliblock00Kernel047[1][0] * (size_t)dims_opensbliblock00Kernel047[1][1];
