...
void ops_par_loop_opensbliblock00Kernel085_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel085_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel085, ydim0_opensbliblock00Kernel085, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel085*1 + n_z * xdim0_opensbliblock00Kernel085 * ydim0_opensbliblock00Kernel085*1);
        ACC<double> rhou0_B0(xdim1_opensbliblock00Kernel085, ydim1_opensbliblock00Kernel085, &rhou0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel085*1 + n_z * xdim1_opensbliblock00Kernel085 * ydim1_opensbliblock00Kernel085*1);
        ACC<double> rho_B0(xdim2_opensbliblock00Kernel085, ydim2_opensbliblock00Kernel085, &rho_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel085*1 + n_z * xdim2_opensbliblock00Kernel085 * ydim2_opensbliblock00Kernel085*1);
        ACC<double> rhou2_B0(xdim3_opensbliblock00Kernel085, ydim3_opensbliblock00Kernel085, &rhou2_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel085*1 + n_z * xdim3_opensbliblock00Kernel085 * ydim3_opensbliblock00Kernel085*1);
        ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel085, ydim4_opensbliblock00Kernel085, &rhou1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel085*1 + n_z * xdim4_opensbliblock00Kernel085 * ydim4_opensbliblock00Kernel085*1);
        //USER CODE
