  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhou0_B0(xdim0_opensbliblock00Kernel024, ydim0_opensbliblock00Kernel024, &rhou0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel024*1 + n_z * xdim0_opensbliblock00Kernel024 * ydim0_opensbliblock00Kernel024*1);
        ...
        ACC<double> u0_B0(xdim2_opensbliblock00Kernel024, ydim2_opensbliblock00Kernel024, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel024*1 + n_z * xdim2_opensbliblock00Kernel024 * ydim2_opensbliblock00Kernel024*1);
        //USER CODE
