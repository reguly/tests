  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> wk41_B0(xdim0_opensbliblock00Kernel015, ydim0_opensbliblock00Kernel015, &wk41_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel015*1 + n_z * xdim0_opensbliblock00Kernel015 * ydim0_opensbliblock00Kernel015*1);
    ...
    wk8_B0(0,0,0) = inv_0_sycl[0]*((rc8_sycl[0])*wk41_B0(0,-2,0) - rc8_sycl[0]*wk41_B0(0,2,0) +
      (rc7_sycl[0])*wk41_B0(0,1,0) - rc7_sycl[0]*wk41_B0(0,-1,0));
