  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rhou2_B0(xdim3_opensbliblock00Kernel083, ydim3_opensbliblock00Kernel083, &rhou2_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel083*1 + n_z * xdim3_opensbliblock00Kernel083 * ydim3_opensbliblock00Kernel083*1);
        ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel083, ydim4_opensbliblock00Kernel083, &rhou1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel083*1 + n_z * xdim4_opensbliblock00Kernel083 * ydim4_opensbliblock00Kernel083*1);
        //USER CODE
