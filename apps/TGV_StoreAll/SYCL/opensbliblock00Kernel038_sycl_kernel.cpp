...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,10,"opensbliblock00Kernel038");
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rho_B0(xdim0_opensbliblock00Kernel038, ydim0_opensbliblock00Kernel038, &rho_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel038*1 + n_z * xdim0_opensbliblock00Kernel038 * ydim0_opensbliblock00Kernel038*1);
        const ACC<double> rhou2_B0(xdim1_opensbliblock00Kernel038, ydim1_opensbliblock00Kernel038, &rhou2_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel038*1 + n_z * xdim1_opensbliblock00Kernel038 * ydim1_opensbliblock00Kernel038*1);
        ACC<double> u2_B0(xdim2_opensbliblock00Kernel038, ydim2_opensbliblock00Kernel038, &u2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel038*1 + n_z * xdim2_opensbliblock00Kernel038 * ydim2_opensbliblock00Kernel038*1);
        //USER CODE
