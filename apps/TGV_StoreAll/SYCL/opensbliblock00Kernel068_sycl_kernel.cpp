...
void ops_par_loop_opensbliblock00Kernel068_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,70,"opensbliblock00Kernel068");
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel068, ydim0_opensbliblock00Kernel068, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel068*1 + n_z * xdim0_opensbliblock00Kernel068 * ydim0_opensbliblock00Kernel068*1);
        ACC<double> wk16_B0(xdim1_opensbliblock00Kernel068, ydim1_opensbliblock00Kernel068, &wk16_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel068*1 + n_z * xdim1_opensbliblock00Kernel068 * ydim1_opensbliblock00Kernel068*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
          
    wk16_B0(0,0,0) = -rc8_sycl[0]*inv_5_sycl[0]*(T_B0(0,0,2) - 16*T_B0(0,0,1) - 16*T_B0(0,0,-1)
