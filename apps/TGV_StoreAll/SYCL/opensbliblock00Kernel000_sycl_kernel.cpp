  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> p_B0(xdim0_opensbliblock00Kernel000, ydim0_opensbliblock00Kernel000, &p_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1 + n_z * xdim0_opensbliblock00Kernel000 * ydim0_opensbliblock00Kernel000*1);
        const ACC<double> u1_B0(xdim1_opensbliblock00Kernel000, ydim1_opensbliblock00Kernel000, &u1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1 + n_z * xdim1_opensbliblock00Kernel000 * ydim1_opensbliblock00Kernel000*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel000, ydim2_opensbliblock00Kernel000, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1 + n_z * xdim2_opensbliblock00Kernel000 * ydim2_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel000, ydim3_opensbliblock00Kernel000, &rhou0_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1 + n_z * xdim3_opensbliblock00Kernel000 * ydim3_opensbliblock00Kernel000*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel000, ydim4_opensbliblock00Kernel000, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1 + n_z * xdim4_opensbliblock00Kernel000 * ydim4_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel000, ydim5_opensbliblock00Kernel000, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1 + n_z * xdim5_opensbliblock00Kernel000 * ydim5_opensbliblock00Kernel000*1);
        const ACC<double> rhou2_B0(xdim6_opensbliblock00Kernel000, ydim6_opensbliblock00Kernel000, &rhou2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1 + n_z * xdim6_opensbliblock00Kernel000 * ydim6_opensbliblock00Kernel000*1);
        ACC<double> wk39_B0(xdim7_opensbliblock00Kernel000, ydim7_opensbliblock00Kernel000, &wk39_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1 + n_z * xdim7_opensbliblock00Kernel000 * ydim7_opensbliblock00Kernel000*1);
        ACC<double> wk42_B0(xdim8_opensbliblock00Kernel000, ydim8_opensbliblock00Kernel000, &wk42_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1 + n_z * xdim8_opensbliblock00Kernel000 * ydim8_opensbliblock00Kernel000*1);
        ACC<double> wk41_B0(xdim9_opensbliblock00Kernel000, ydim9_opensbliblock00Kernel000, &wk41_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1 + n_z * xdim9_opensbliblock00Kernel000 * ydim9_opensbliblock00Kernel000*1);
        ACC<double> wk40_B0(xdim10_opensbliblock00Kernel000, ydim10_opensbliblock00Kernel000, &wk40_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1 + n_z * xdim10_opensbliblock00Kernel000 * ydim10_opensbliblock00Kernel000*1);
        ACC<double> wk44_B0(xdim11_opensbliblock00Kernel000, ydim11_opensbliblock00Kernel000, &wk44_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1 + n_z * xdim11_opensbliblock00Kernel000 * ydim11_opensbliblock00Kernel000*1);
        ACC<double> wk43_B0(xdim12_opensbliblock00Kernel000, ydim12_opensbliblock00Kernel000, &wk43_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1 + n_z * xdim12_opensbliblock00Kernel000 * ydim12_opensbliblock00Kernel000*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
          
   wk39_B0(0,0,0) = p_B0(0,0,0)*u1_B0(0,0,0);

   wk40_B0(0,0,0) = rhou2_B0(0,0,0)*u1_B0(0,0,0);
   ...
   wk44_B0(0,0,0) = rhou1_B0(0,0,0)*u1_B0(0,0,0);
