  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> wk26_B0(xdim1_opensbliblock00Kernel037, ydim1_opensbliblock00Kernel037, &wk26_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel037*1 + n_z * xdim1_opensbliblock00Kernel037 * ydim1_opensbliblock00Kernel037*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
          
    wk26_B0(0,0,0) = inv_2_sycl[0]*(-rc7_sycl[0]*p_B0(0,0,-1) - rc8_sycl[0]*p_B0(0,0,2) +
      (rc8_sycl[0])*p_B0(0,0,-2) + (rc7_sycl[0])*p_B0(0,0,1));
