...
void opensbliblock00Kernel043(const ptr_double u2_B0,
  ptr_double wk31_B0)
{
    OPS_ACC(wk31_B0, 0,0,0) = inv_2*(-rc7*OPS_ACC(u2_B0, 0,0,-1) + (rc7)*OPS_ACC(u2_B0, 0,0,1) +
      (rc8)*OPS_ACC(u2_B0, 0,0,-2) - rc8*OPS_ACC(u2_B0, 0,0,2));
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        opensbliblock00Kernel043( ptr0, ptr1);
      }
    }
  }
}
