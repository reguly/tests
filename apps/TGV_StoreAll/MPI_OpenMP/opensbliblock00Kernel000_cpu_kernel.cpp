...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk39_B0_p = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ wk42_B0_p = (double *)(args[8].data + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ wk41_B0_p = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ wk40_B0_p = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ wk44_B0_p = (double *)(args[11].data + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ wk43_B0_p = (double *)(args[12].data + base12);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> u1_B0(xdim1_opensbliblock00Kernel000, ydim1_opensbliblock00Kernel000, u1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1 + n_z * xdim1_opensbliblock00Kernel000 * ydim1_opensbliblock00Kernel000*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel000, ydim2_opensbliblock00Kernel000, rhoE_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1 + n_z * xdim2_opensbliblock00Kernel000 * ydim2_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel000, ydim3_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1 + n_z * xdim3_opensbliblock00Kernel000 * ydim3_opensbliblock00Kernel000*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel000, ydim4_opensbliblock00Kernel000, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1 + n_z * xdim4_opensbliblock00Kernel000 * ydim4_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel000, ydim5_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1 + n_z * xdim5_opensbliblock00Kernel000 * ydim5_opensbliblock00Kernel000*1);
        const ACC<double> rhou2_B0(xdim6_opensbliblock00Kernel000, ydim6_opensbliblock00Kernel000, rhou2_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1 + n_z * xdim6_opensbliblock00Kernel000 * ydim6_opensbliblock00Kernel000*1);
        ACC<double> wk39_B0(xdim7_opensbliblock00Kernel000, ydim7_opensbliblock00Kernel000, wk39_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1 + n_z * xdim7_opensbliblock00Kernel000 * ydim7_opensbliblock00Kernel000*1);
        ACC<double> wk42_B0(xdim8_opensbliblock00Kernel000, ydim8_opensbliblock00Kernel000, wk42_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1 + n_z * xdim8_opensbliblock00Kernel000 * ydim8_opensbliblock00Kernel000*1);
        ACC<double> wk41_B0(xdim9_opensbliblock00Kernel000, ydim9_opensbliblock00Kernel000, wk41_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1 + n_z * xdim9_opensbliblock00Kernel000 * ydim9_opensbliblock00Kernel000*1);
        ACC<double> wk40_B0(xdim10_opensbliblock00Kernel000, ydim10_opensbliblock00Kernel000, wk40_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1 + n_z * xdim10_opensbliblock00Kernel000 * ydim10_opensbliblock00Kernel000*1);
        ACC<double> wk44_B0(xdim11_opensbliblock00Kernel000, ydim11_opensbliblock00Kernel000, wk44_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1 + n_z * xdim11_opensbliblock00Kernel000 * ydim11_opensbliblock00Kernel000*1);
        ACC<double> wk43_B0(xdim12_opensbliblock00Kernel000, ydim12_opensbliblock00Kernel000, wk43_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1 + n_z * xdim12_opensbliblock00Kernel000 * ydim12_opensbliblock00Kernel000*1);
