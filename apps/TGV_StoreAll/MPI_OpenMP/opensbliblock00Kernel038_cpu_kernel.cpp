  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> rho_B0(xdim0_opensbliblock00Kernel038, ydim0_opensbliblock00Kernel038, rho_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel038*1 + n_z * xdim0_opensbliblock00Kernel038 * ydim0_opensbliblock00Kernel038*1);
        const ACC<double> rhou2_B0(xdim1_opensbliblock00Kernel038, ydim1_opensbliblock00Kernel038, rhou2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel038*1 + n_z * xdim1_opensbliblock00Kernel038 * ydim1_opensbliblock00Kernel038*1);
        ACC<double> u2_B0(xdim2_opensbliblock00Kernel038, ydim2_opensbliblock00Kernel038, u2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel038*1 + n_z * xdim2_opensbliblock00Kernel038 * ydim2_opensbliblock00Kernel038*1);
