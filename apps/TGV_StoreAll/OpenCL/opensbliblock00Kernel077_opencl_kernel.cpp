...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel077(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel077) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[75] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel077", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[75], 2, sizeof(cl_double), (void*) &inv_4 ));
