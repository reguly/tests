...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel084(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel084) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel084", &ret);
        clSafeCall( ret );
