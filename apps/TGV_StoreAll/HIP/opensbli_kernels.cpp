...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"rc8")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(rc8, dat, dim*size));
  }
  else
  if (!strcmp(name,"rcinv9")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(rcinv9, dat, dim*size));
  }
  else
  if (!strcmp(name,"rc10")) {
  ...
  if (!strcmp(name,"rc11")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(rc11, dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"rcinv14")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(rcinv14, dat, dim*size));
  }
  else
  {
