...
extern int xdim2_calc_ytemp2_kernel;
int xdim2_calc_ytemp2_kernel_h = -1;
extern int ydim2_calc_ytemp2_kernel;
int ydim2_calc_ytemp2_kernel_h = -1;
extern int zdim2_calc_ytemp2_kernel;
int zdim2_calc_ytemp2_kernel_h = -1;
extern int xdim3_calc_ytemp2_kernel;
int xdim3_calc_ytemp2_kernel_h = -1;
extern int ydim3_calc_ytemp2_kernel;
int ydim3_calc_ytemp2_kernel_h = -1;
extern int zdim3_calc_ytemp2_kernel;
int zdim3_calc_ytemp2_kernel_h = -1;
extern int xdim4_calc_ytemp2_kernel;
int xdim4_calc_ytemp2_kernel_h = -1;
extern int ydim4_calc_ytemp2_kernel;
int ydim4_calc_ytemp2_kernel_h = -1;
extern int zdim4_calc_ytemp2_kernel;
int zdim4_calc_ytemp2_kernel_h = -1;
...
void ops_par_loop_calc_ytemp2_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4) {
  ...
  if (xdim2 != xdim2_calc_ytemp2_kernel_h || ydim2 != ydim2_calc_ytemp2_kernel_h || zdim2 != zdim2_calc_ytemp2_kernel_h || xdim3 != xdim3_calc_ytemp2_kernel_h || ydim3 != ydim3_calc_ytemp2_kernel_h || zdim3 != zdim3_calc_ytemp2_kernel_h || xdim4 != xdim4_calc_ytemp2_kernel_h || ydim4 != ydim4_calc_ytemp2_kernel_h || zdim4 != zdim4_calc_ytemp2_kernel_h) {
    xdim2_calc_ytemp2_kernel = xdim2;
    xdim2_calc_ytemp2_kernel_h = xdim2;
    ydim2_calc_ytemp2_kernel = ydim2;
    ydim2_calc_ytemp2_kernel_h = ydim2;
    zdim2_calc_ytemp2_kernel = zdim2;
    zdim2_calc_ytemp2_kernel_h = zdim2;
    xdim3_calc_ytemp2_kernel = xdim3;
    xdim3_calc_ytemp2_kernel_h = xdim3;
    ydim3_calc_ytemp2_kernel = ydim3;
    ydim3_calc_ytemp2_kernel_h = ydim3;
    zdim3_calc_ytemp2_kernel = zdim3;
    zdim3_calc_ytemp2_kernel_h = zdim3;
    xdim4_calc_ytemp2_kernel = xdim4;
    xdim4_calc_ytemp2_kernel_h = xdim4;
    ydim4_calc_ytemp2_kernel = ydim4;
    ydim4_calc_ytemp2_kernel_h = ydim4;
    zdim4_calc_ytemp2_kernel = zdim4;
    zdim4_calc_ytemp2_kernel_h = zdim4;
  }
