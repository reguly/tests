...
//
    ...
    void buildOpenCLKernels_fd3d_pml_kernel(OPS_instance *instance, int xdim0, int ydim0, int zdim0, int xdim1, int ydim1, int zdim1, int xdim2, int ydim2, int zdim2, int xdim3, int ydim3, int zdim3) {
      ...
      if(!isbuilt_fd3d_pml_kernel) {
        ...
        instance->ostream() <<"Compiling fd3d_pml_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_fd3d_pml_kernel=%d  -Dydim0_fd3d_pml_kernel=%d  -Dzdim0_fd3d_pml_kernel=%d  -Dxdim1_fd3d_pml_kernel=%d  -Dydim1_fd3d_pml_kernel=%d  -Dzdim1_fd3d_pml_kernel=%d  -Dxdim2_fd3d_pml_kernel=%d  -Dydim2_fd3d_pml_kernel=%d  -Dzdim2_fd3d_pml_kernel=%d  -Dxdim3_fd3d_pml_kernel=%d  -Dydim3_fd3d_pml_kernel=%d  -Dzdim3_fd3d_pml_kernel=%d ", pPath, 32,xdim0,ydim0,zdim0,xdim1,ydim1,zdim1,xdim2,ydim2,zdim2,xdim3,ydim3,zdim3);
            else
          ...
          instance->ostream() << "compiling fd3d_pml_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[1] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_fd3d_pml_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_fd3d_pml_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  buildOpenCLKernels_fd3d_pml_kernel(block->instance,
  xdim0,ydim0,zdim0,xdim1,ydim1,zdim1,xdim2,ydim2,zdim2,xdim3,ydim3,zdim3);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 4, sizeof(cl_float), (void*) &invdx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 5, sizeof(cl_float), (void*) &invdy ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 6, sizeof(cl_float), (void*) &invdz ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 7, sizeof(cl_int), (void*) &pml_width ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 8, sizeof(cl_int), (void*) &xbeg ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 9, sizeof(cl_int), (void*) &ybeg ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 10, sizeof(cl_int), (void*) &zbeg ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 11, sizeof(cl_int), (void*) &xend ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 12, sizeof(cl_int), (void*) &yend ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 13, sizeof(cl_int), (void*) &zend ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 14, sizeof(cl_int), (void*) &halff ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 15, sizeof(cl_float), (void*) &c ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 16, sizeof(cl_float), (void*) &cx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 17, sizeof(cl_float), (void*) &cy ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 18, sizeof(cl_float), (void*) &cz ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 19, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 20, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 21, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 22, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 23, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 24, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 25, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 26, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 27, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[1], 28, sizeof(cl_int), (void*) &z_size ));
