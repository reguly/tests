...
void ops_par_loop_fd3d_pml_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  #ifdef OPS_GPU
  float *p_a0 = (float *)((char *)args[0].data_d + base0);
  #else
  float *p_a0 = (float *)((char *)args[0].data + base0);
  #endif
  ...
  if (xdim0 != xdim0_fd3d_pml_kernel_h || ydim0 != ydim0_fd3d_pml_kernel_h || xdim1 != xdim1_fd3d_pml_kernel_h || ydim1 != ydim1_fd3d_pml_kernel_h || xdim2 != xdim2_fd3d_pml_kernel_h || ydim2 != ydim2_fd3d_pml_kernel_h || xdim3 != xdim3_fd3d_pml_kernel_h || ydim3 != ydim3_fd3d_pml_kernel_h) {
