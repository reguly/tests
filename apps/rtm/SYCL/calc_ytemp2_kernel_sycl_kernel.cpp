...
void ops_par_loop_calc_ytemp2_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "calc_ytemp2_kernel");
  #endif
  ...
  int xdim2_calc_ytemp2_kernel = args[2].dat->size[0];
  int ydim2_calc_ytemp2_kernel = args[2].dat->size[1];
  int zdim2_calc_ytemp2_kernel = args[2].dat->size[2];
  int xdim3_calc_ytemp2_kernel = args[3].dat->size[0];
  int ydim3_calc_ytemp2_kernel = args[3].dat->size[1];
  int zdim3_calc_ytemp2_kernel = args[3].dat->size[2];
  int xdim4_calc_ytemp2_kernel = args[4].dat->size[0];
  int ydim4_calc_ytemp2_kernel = args[4].dat->size[1];
  int zdim4_calc_ytemp2_kernel = args[4].dat->size[2];
  ...
  block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
      cgh.parallel_for<class calc_ytemp2_kernel_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        #ifdef OPS_SOA
        const ACC<float> yy(6, xdim2_calc_ytemp2_kernel, ydim2_calc_ytemp2_kernel, zdim2_calc_ytemp2_kernel, &Accessor_yy[0] + base2 + n_x*1 + n_y * xdim2_calc_ytemp2_kernel*1 + n_z * xdim2_calc_ytemp2_kernel * ydim2_calc_ytemp2_kernel*1);
        #else
        const ACC<float> yy(6, xdim2_calc_ytemp2_kernel, ydim2_calc_ytemp2_kernel, zdim2_calc_ytemp2_kernel, &Accessor_yy[0] + 6*(n_x*1 + n_y * xdim2_calc_ytemp2_kernel*1 + n_z * xdim2_calc_ytemp2_kernel * ydim2_calc_ytemp2_kernel*1));
        #endif
        #ifdef OPS_SOA
        ACC<float> k(6, xdim3_calc_ytemp2_kernel, ydim3_calc_ytemp2_kernel, zdim3_calc_ytemp2_kernel, &Accessor_k[0] + base3 + n_x*1 + n_y * xdim3_calc_ytemp2_kernel*1 + n_z * xdim3_calc_ytemp2_kernel * ydim3_calc_ytemp2_kernel*1);
        #else
        ACC<float> k(6, xdim3_calc_ytemp2_kernel, ydim3_calc_ytemp2_kernel, zdim3_calc_ytemp2_kernel, &Accessor_k[0] + 6*(n_x*1 + n_y * xdim3_calc_ytemp2_kernel*1 + n_z * xdim3_calc_ytemp2_kernel * ydim3_calc_ytemp2_kernel*1));
        #endif
        #ifdef OPS_SOA
        ACC<float> ytemp(6, xdim4_calc_ytemp2_kernel, ydim4_calc_ytemp2_kernel, zdim4_calc_ytemp2_kernel, &Accessor_ytemp[0] + base4 + n_x*1 + n_y * xdim4_calc_ytemp2_kernel*1 + n_z * xdim4_calc_ytemp2_kernel * ydim4_calc_ytemp2_kernel*1);
        #else
        ACC<float> ytemp(6, xdim4_calc_ytemp2_kernel, ydim4_calc_ytemp2_kernel, zdim4_calc_ytemp2_kernel, &Accessor_ytemp[0] + 6*(n_x*1 + n_y * xdim4_calc_ytemp2_kernel*1 + n_z * xdim4_calc_ytemp2_kernel * ydim4_calc_ytemp2_kernel*1));
        #endif
