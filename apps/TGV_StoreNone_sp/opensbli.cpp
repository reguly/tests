...
int main(int argc, char **argv) 
{
  ...
  ops_decl_const("rcinv8" , 1, "float", &rcinv8);
  ops_decl_const("rc9" , 1, "float", &rc9);
  ops_decl_const("rc10" , 1, "float", &rc10);
  ops_decl_const("rcinv11" , 1, "float", &rcinv11);
  ops_decl_const("rcinv12" , 1, "float", &rcinv12);
  ops_decl_const("rcinv13" , 1, "float", &rcinv13);
  ops_decl_const("rc14" , 1, "float", &rc14);
...
#include "defdec_data_set.h"
  ...
  ops_par_loop(opensbliblock00Kernel032, "Grid_based_initialisation0", opensbliblock00, 3, iteration_range_32_block0,
      ops_arg_dat(rhoE_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ops_arg_dat(rhou0_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ops_arg_dat(rhou2_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ops_arg_dat(rhou1_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ops_arg_idx());
  ...
  for(int iter=0; iter<=niter - 1; iter++)
  {
    ...
    ops_par_loop(opensbliblock00Kernel026, "Symmetry boundary dir0 side0", opensbliblock00, 3, iteration_range_26_block0,
        ops_arg_dat(rhoE_B0, 1, stencil_0_07, "float", OPS_RW),
        ops_arg_dat(rho_B0, 1, stencil_0_07, "float", OPS_RW),
        ops_arg_dat(rhou0_B0, 1, stencil_0_07, "float", OPS_RW),
        ops_arg_dat(rhou2_B0, 1, stencil_0_07, "float", OPS_RW),
        ops_arg_dat(rhou1_B0, 1, stencil_0_07, "float", OPS_RW));
    ...
    ops_par_loop(opensbliblock00Kernel028, "Symmetry boundary dir1 side0", opensbliblock00, 3, iteration_range_28_block0,
        ops_arg_dat(rhoE_B0, 1, stencil_0_09, "float", OPS_RW),
        ops_arg_dat(rho_B0, 1, stencil_0_09, "float", OPS_RW),
        ops_arg_dat(rhou0_B0, 1, stencil_0_09, "float", OPS_RW),
        ops_arg_dat(rhou2_B0, 1, stencil_0_09, "float", OPS_RW),
        ops_arg_dat(rhou1_B0, 1, stencil_0_09, "float", OPS_RW));
    ...
    ops_par_loop(opensbliblock00Kernel030, "Symmetry boundary dir2 side0", opensbliblock00, 3, iteration_range_30_block0,
        ops_arg_dat(rhoE_B0, 1, stencil_0_08, "float", OPS_RW),
        ops_arg_dat(rho_B0, 1, stencil_0_08, "float", OPS_RW),
        ops_arg_dat(rhou0_B0, 1, stencil_0_08, "float", OPS_RW),
        ops_arg_dat(rhou2_B0, 1, stencil_0_08, "float", OPS_RW),
        ops_arg_dat(rhou1_B0, 1, stencil_0_08, "float", OPS_RW));
    ...
    ops_par_loop(opensbliblock00Kernel033, "Save equations", opensbliblock00, 3, iteration_range_33_block0,
        ...
        ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_03, "float", OPS_WRITE),
        ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_03, "float", OPS_WRITE),
        ops_arg_dat(rho_RKold_B0, 1, stencil_0_03, "float", OPS_WRITE),
        ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_03, "float", OPS_WRITE),
        ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_03, "float", OPS_WRITE));
    ...
    for(int stage=0; stage<=2; stage++)
    {
      ...
      ops_par_loop(opensbliblock00Kernel001, "CRu0_B0", opensbliblock00, 3, iteration_range_1_block0,
          ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou0_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(u0_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel005, "CRu1_B0", opensbliblock00, 3, iteration_range_5_block0,
          ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou1_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(u1_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel009, "CRu2_B0", opensbliblock00, 3, iteration_range_9_block0,
          ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou2_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(u2_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel017, "CRp_B0", opensbliblock00, 3, iteration_range_17_block0,
          ...
          ops_arg_dat(p_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel018, "CRT_B0", opensbliblock00, 3, iteration_range_18_block0,
          ...
          ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(T_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel000, "Derivative evaluation CD u0_B0 x0 ", opensbliblock00, 3, iteration_range_0_block0,
          ops_arg_dat(u0_B0, 1, stencil_0_07, "float", OPS_READ),
          ops_arg_dat(wk0_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel002, "Derivative evaluation CD u0_B0 x2 ", opensbliblock00, 3, iteration_range_2_block0,
          ops_arg_dat(u0_B0, 1, stencil_0_08, "float", OPS_READ),
          ops_arg_dat(wk1_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel003, "Derivative evaluation CD u0_B0 x1 ", opensbliblock00, 3, iteration_range_3_block0,
          ops_arg_dat(u0_B0, 1, stencil_0_09, "float", OPS_READ),
          ops_arg_dat(wk2_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel004, "Derivative evaluation CD u1_B0 x0 ", opensbliblock00, 3, iteration_range_4_block0,
          ops_arg_dat(u1_B0, 1, stencil_0_07, "float", OPS_READ),
          ops_arg_dat(wk3_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel006, "Derivative evaluation CD u1_B0 x2 ", opensbliblock00, 3, iteration_range_6_block0,
          ops_arg_dat(u1_B0, 1, stencil_0_08, "float", OPS_READ),
          ops_arg_dat(wk4_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel007, "Derivative evaluation CD u1_B0 x1 ", opensbliblock00, 3, iteration_range_7_block0,
          ops_arg_dat(u1_B0, 1, stencil_0_09, "float", OPS_READ),
          ops_arg_dat(wk5_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel008, "Derivative evaluation CD u2_B0 x0 ", opensbliblock00, 3, iteration_range_8_block0,
          ops_arg_dat(u2_B0, 1, stencil_0_07, "float", OPS_READ),
          ops_arg_dat(wk6_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel010, "Derivative evaluation CD u2_B0 x2 ", opensbliblock00, 3, iteration_range_10_block0,
          ops_arg_dat(u2_B0, 1, stencil_0_08, "float", OPS_READ),
          ops_arg_dat(wk7_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel011, "Derivative evaluation CD u2_B0 x1 ", opensbliblock00, 3, iteration_range_11_block0,
          ops_arg_dat(u2_B0, 1, stencil_0_09, "float", OPS_READ),
          ops_arg_dat(wk8_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel024, "Convective terms", opensbliblock00, 3, iteration_range_24_block0,
          ...
          ops_arg_dat(wk7_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(p_B0, 1, stencil_0_01, "float", OPS_READ),
          ops_arg_dat(rho_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(wk5_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou0_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(wk0_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou2_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(rhou1_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(Residual4_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(Residual3_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(Residual1_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(Residual0_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(Residual2_B0, 1, stencil_0_03, "float", OPS_WRITE));
      ...
      ops_par_loop(opensbliblock00Kernel025, "Viscous terms", opensbliblock00, 3, iteration_range_25_block0,
          ops_arg_dat(wk8_B0, 1, stencil_0_05, "float", OPS_READ),
          ops_arg_dat(wk3_B0, 1, stencil_0_02, "float", OPS_READ),
          ops_arg_dat(wk2_B0, 1, stencil_0_03, "float", OPS_READ),
          ...
          ops_arg_dat(wk4_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(wk7_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(T_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(u2_B0, 1, stencil_0_00, "float", OPS_READ),
          ops_arg_dat(wk5_B0, 1, stencil_0_05, "float", OPS_READ),
          ops_arg_dat(wk0_B0, 1, stencil_0_06, "float", OPS_READ),
          ops_arg_dat(wk6_B0, 1, stencil_0_05, "float", OPS_READ),
          ops_arg_dat(Residual4_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(Residual1_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(Residual3_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(Residual2_B0, 1, stencil_0_03, "float", OPS_RW));
      ...
      ops_par_loop(opensbliblock00Kernel035, "Sub stage advancement", opensbliblock00, 3, iteration_range_35_block0,
          ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual3_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rho_RKold_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual1_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual0_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual4_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual2_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhoE_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(rho_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(rhou0_B0, 1, stencil_0_03, "float", OPS_WRITE),
          ops_arg_dat(rhou2_B0, 1, stencil_0_03, "float", OPS_WRITE),
      ...
      ops_par_loop(opensbliblock00Kernel034, "Temporal solution advancement", opensbliblock00, 3, iteration_range_34_block0,
          ...
          ops_arg_dat(Residual4_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(Residual2_B0, 1, stencil_0_03, "float", OPS_READ),
          ops_arg_dat(rhoE_RKold_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(rho_RKold_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(rhou0_RKold_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(rhou2_RKold_B0, 1, stencil_0_03, "float", OPS_RW),
          ops_arg_dat(rhou1_RKold_B0, 1, stencil_0_03, "float", OPS_RW),
